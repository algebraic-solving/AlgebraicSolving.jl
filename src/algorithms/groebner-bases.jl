...
@doc Markdown.doc"""
    eliminate(F::Vector{T} where T <: MPolyElem, eliminate::Int,  <keyword arguments>)

Compute a Groebner basis of the ideal generated by `F` w.r.t. to the product monomial ordering defined by two blocks
...
function eliminate(
    ...
    if eliminate <= 0
        ...
        return groebner_basis(F, initial_hts=initial_hts, nr_thrds=nr_thrds,
