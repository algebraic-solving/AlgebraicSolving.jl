...
julia> real_solutions(F)
4-element Vector{Vector{Nemo.fmpq}}:
...
(84*x^4 - 40*x^3 + x^2 + x, 336*x^3 - 120*x^2 + 2*x + 1, AbstractAlgebra.PolyElem[-184*x^3 + 80*x^2 - 4*x - 1, -36*x^3 + 18*x^2 - 2*x], Nemo.fmpz[-1, -1])
```
"""
